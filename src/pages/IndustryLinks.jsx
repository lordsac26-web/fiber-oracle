...
const INDUSTRY_LINKS = {
  testEquipment: [
    ...
    { name: 'Kingfisher', url: 'https://kingfisherfiber.com', description: 'Power meters, light sources, test kits' },
  ...
  fusionSplicers: [
    ...
    { name: 'Sumitomo Electric', url: 'https://global-sei.com/sumitomo-electric-splicers/americas/', description: 'Fusion splicers, fiber products' },
    { name: 'Furukawa Electric (FITEL)', url: 'https://www.furukawaelectric.com/splicer/en/', description: 'Splicers, fiber products — formerly FITEL' },
    { name: 'INNO Instrument', url: 'https://innoinstrument.com', description: 'Affordable fusion splicers' },
    { name: 'Ilsintech', url: 'https://ilsintech.eu', description: 'Swift fusion splicers' },
    { name: 'Orientek', url: 'https://www.orientekot.com', description: 'Budget-friendly splicers' },
  ],
  fiberManufacturers: [
    { name: 'Corning', url: 'https://www.corning.com/optical-communications', description: 'Fiber, cable, connectivity solutions' },
    { name: 'Prysmian Group', url: 'https://www.prysmiangroup.com/en', description: 'Cables and fiber products' },
    ...
    { name: 'Belden', url: 'https://www.belden.com', description: 'Fiber and copper cable, connectivity solutions' },
    { name: 'Superior Essex', url: 'https://www.superioressex.com', description: 'Fiber optic and copper cable manufacturing' },
  ...
  standardsOrganizations: [
    { name: 'TIA (Telecommunications Industry Association)', url: 'https://www.tiaonline.org', description: 'TIA-568, TIA-526, TIA-598, TIA-758 standards' },
    { name: 'IEEE', url: 'https://www.ieee.org', description: 'IEEE 802.3 Ethernet standards' },
    { name: 'IEC', url: 'https://www.iec.ch', description: 'IEC 61300, IEC 60794 connector/cable standards' },
    { name: 'ITU-T', url: 'https://www.itu.int', description: 'G.652, G.657, G.984, G.9807 fiber/PON standards' },
    { name: 'Fiber Optic Association (FOA)', url: 'https://www.thefoa.org', description: 'Industry guidelines, best practices, CFOT certification' },
    { name: 'FOA Reference Guide', url: 'https://www.thefoa.org/tech/ref/contents.html', description: 'Comprehensive technical reference & standards guide' },
    { name: 'Telcordia / Ericsson', url: 'https://www.ericsson.com', description: 'GR-326, GR-20, GR-449 standards' },
    { name: 'ANSI', url: 'https://www.ansi.org', description: 'American National Standards Institute' },
    { name: 'NFPA (NEC)', url: 'https://www.nfpa.org/codes-and-standards/nfpa-70-standard-development/70', description: 'National Electrical Code Article 770' },
    { name: 'OSHA', url: 'https://www.osha.gov', description: 'Workplace safety regulations for fiber installation' },
  ],
  training: [
    ...
    { name: 'Corning Training Programs', url: 'https://www.corning.com/optical-communications/worldwide/en/home/training-and-events/training-programs.html', description: 'See the Light® fiber optic training courses' },
    { name: 'Fiber U (FOA)', url: 'https://fiberu.org', description: 'Free FOA online self-study courses & microcredentials' },
  ...
  suppliers: [
    ...
    { name: 'Netceed', url: 'https://us-store.netceed.com', description: 'FTTH/broadband fiber optic supplies & distribution' },
